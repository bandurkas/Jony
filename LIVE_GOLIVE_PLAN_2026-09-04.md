...
- **02.09: go-live Jony ОТЛОЖЕН (решение пользователя: «профит пока не стабилен»).** Дата 4–5.09 снята; paper продолжается с Track B 02.09. Новый гейт — стабильность: см. чекпойнт советника 19.09 и кривую equity (24.08 $908 → 02.09 $888). BUBU в live первым.
